...
tweets_data = pd.read_csv('F:/assignment/NLP-topic modling & text summarization/NLP-TM/Data.csv', usecols=['text'])
tweets_data.head(10)
...
tweets_data = tweets_data.text.apply(preprocess_string).tolist()

from gensim import corpora
from gensim.models.ldamodel import LdaModel

dictionary = corpora.Dictionary(tweets_data)
corpus = [dictionary.doc2bow(text) for text in tweets_data]
...
def get_coherence_values(start, stop):
    for num_topics in range(start, stop):
        ...
        coherence = calculate_coherence_score(tweets_data, dictionary, ldamodel)
        yield coherence
...
# data loading 
import pandas as pd
my_tweet = pd.read_csv("F:/assignment/NLP-topic modling & text summarization/NLP-TM/Data.csv",usecols=['text'])
...
##################################LDA#################################
article = open('F:/assignment/NLP-topic modling & text summarization/NLP-TM/NLP-TM.txt' , encoding = "utf8")
